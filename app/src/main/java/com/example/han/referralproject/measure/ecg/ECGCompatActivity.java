...
//                            });
                    ...
                    ecgInfo.ecg = boShengResultBean.getStop_light() == 2 ? 1 : boShengResultBean.getStop_light();
                    ecgInfo.heart_rate =boShengResultBean.getAvgbeats().get(0).getHR();
    ...
    protected void backMainActivity() {
        ...
        if (isMeasure) {
            ...
            HealthRecordActivity.MyDialogFragment.newInstance(pdfUrl).show(getSupportFragmentManager(), "ECGPDF");
        }
    }
