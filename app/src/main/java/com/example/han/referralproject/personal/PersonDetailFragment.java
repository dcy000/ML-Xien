        ...
        NetworkApi.PersonInfo(MyApplication.getInstance().userId,
                new NetworkManager.SuccessCallback<UserInfo>() {
                    ...
                    public void onSuccess(UserInfo response) {
                        ...
                        msg.what = 1;
                        msg.obj = response.xfid;
                        mHandler.sendMessage(msg);


                        SharedPreferences.Editor editor = sharedPreferences1.edit();
                        editor.putString("userName", response.bname);
                        editor.commit();
                        MyApplication.getInstance().userName = response.bname;
                        mTextView.setText(response.bname);
                        ...
                        } else if (!TextUtils.isEmpty(response.doctername)) {
